...
//////////////////////  Settings for TEXT //////////////////////
		...
		var loading_text=window.famobi.__("Loading...");						//loading text
...
//////////////////////  LOADING BAR SETTINGS ////////////////////////////////
		...
		var barheight = 15;                          				// Loading bar height in pixel
		var x = (_width - barwidth) / 2;					// Loading bar orizizontal position (in example centered horizontally)
		var y = (_height - barheight) / 2;					// Loading bar vertical position (in example moved 150px down from center) -- 150 + (_height - barheight) / 2;
		var w = (barwidth / _total) * _current;         			//variable to calculate width during loading progress, DON'T EDIT
		var border=4   								// Bar border width in pixel
		var border_color= "rgb(0,255,255)";   					//Bar border color in rgb
...
//////////////////// CUSTOM IMAGE SETTINGS TO BE USED INSTEAD OR TOGETHER GM:S LOADING SCREEN, LEAVE URL EMPTY IF NOT NEEDED
		...
		customlogo.src = "html5game/loading_title.png"; //URL to custom image, leave empty in not needed
		var imgheight= 30;							//custom image height in pixel (use _height to fit canvas)
		var imgwidth= 162;							//custom image width in pixel (use _width to fit canvas)
		var fromtop=((_height - imgheight)/2) - 45;  				//custom image vertical position (centered in example)
...
function js_changeCanvasClass() {

	document.getElementById("gm4html5_div_id").className = "gm4html5_div_class_2";
}
